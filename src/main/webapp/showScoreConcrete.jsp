...
<body background="image/bkg.png">
	<div class="card">
		<form action="queryScoreConcrete" method="get">
			<p style="font-size:30px;">请输入要查询量化详细信息的教师的工号</p>
			<input type="text" name="tid" placeholder="0000" class="input" required="required"></td>
			<button>提交</button>
		</form>
	</div>
</body>

...
<form action="updateTeacher" method="get">
	<center><i>请输入要修改老师的信息(不用填写完整)</i></center>
	<br>
	<br>工号：<input type="text" name="tid" style="width: 50px;">
	<br>教师身份：<input type="text" name="identity" style="width: 70px;">
